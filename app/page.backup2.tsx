...
<main className="min-h-screen overflow-x-hidden bg-gray-950 text-white">
    ...
    <div className="mx-auto flex min-h-16 w-full max-w-7xl items-center justify-between gap-3 px-3 sm:px-5 lg:px-6">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <select
          ...
          className="w-[145px] rounded-lg border border-gray-700 bg-gray-900 px-2 py-2 text-xs text-gray-200 outline-none focus:border-blue-500 sm:w-auto sm:px-3"
        >
  ...
  <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 p-3 sm:p-5 md:min-h-[calc(100vh-64px)] md:flex-row md:gap-5 md:p-6">
    ...
    {/* PROMPT */}
    <section
      className={`w-full flex-col rounded-2xl border border-gray-800 bg-gray-900 p-3 shadow-xl sm:p-5 md:w-[38%] md:flex-1 ${
        activeTab === 'prompt'
          ? 'flex'
          : 'hidden md:flex'
      }`}
    >
      ...
      {/* TEXTAREA */}
      <textarea
        className="min-h-[240px] w-full flex-1 resize-none rounded-xl border border-gray-700 bg-gray-950 p-4 text-sm leading-6 text-white outline-none placeholder:text-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 sm:min-h-[320px] sm:text-base"
      ...
      <button
        ...
        className="mt-3 min-h-12 w-full shrink-0 rounded-xl bg-blue-600 px-4 text-sm font-semibold text-white transition hover:bg-blue-500 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40 sm:min-h-14 sm:text-base"
      >
        {loading ? (
      ...
      {/* INFO */}
      <div className="mt-3 hidden shrink-0 rounded-xl border border-gray-800 bg-gray-950 p-3 sm:block">
    ...
    {/* APERCU */}
    <section
      className={`w-full min-w-0 flex-col overflow-hidden rounded-2xl border border-gray-800 bg-white shadow-xl md:flex-1 ${
        activeTab === 'preview'
          ? 'flex'
          : 'hidden md:flex'
      }`}
    >
      ...
      {/* APERCU IFRAME */}
      <div className="min-h-[calc(100vh-190px)] flex-1 md:min-h-0">
        ...
        {generatedCode ? (
          <iframe
            ...
            className="block h-full min-h-[calc(100vh-190px)] w-full border-0 bg-white md:min-h-0"
            sandbox="allow-scripts allow-forms allow-modals allow-popups"
          />
        ) : (
          <div className="flex min-h-[calc(100vh-190px)] flex-col items-center justify-center bg-gray-950 px-6 text-center">
